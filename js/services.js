...
(function () {
  ...
  function renderAllServicesGrid() {
    ...
    const cats = [
      ...
      { id: 'transport', emoji: '🚗', title: 'Car & Transfers', desc: 'Private airport transfers, luxury chauffeur vehicles and road trip packages.', count: transportCatalogDb.length, color: '#fb923c', border: 'rgba(251,146,60,0.3)', img: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=800&q=85' },
